...
<body class="bg-white">
    ...
    <!-- Hero Section -->
    <section class="bg-gradient-to-br from-indigo-900 via-indigo-800 to-indigo-900 text-white pt-24 pb-16 px-6 relative overflow-hidden min-h-screen flex items-center">
        <!-- Decorative elements -->
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="space-y-8">
                    <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight">
                        Experience God<br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">Just As You Are</span>
                    </h1>
                    <p class="text-lg md:text-xl text-gray-200 max-w-xl leading-relaxed">
                        Join us for a life-changing worship experience where you can encounter God's presence and be transformed.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="contact-us.php" class="btn-hover border-2 border-white px-8 py-4 hover:bg-white hover:text-indigo-900 font-semibold text-center rounded-lg transition-all duration-300 uppercase tracking-wider">
                            GET CONNECTED
                        </a>
                        <a href="https://www.youtube.com/@rccgriversprovince1hq820/streams" class="btn-hover bg-green-600 px-8 py-4 hover:bg-green-700 font-semibold flex items-center justify-center rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 uppercase tracking-wider">
                ...
                <div class="relative">
                    <div class="relative">
                        <img src="images/oh/02.jpg" alt="Church Service" class="rounded-2xl shadow-2xl w-full object-cover h-[500px] ring-4 ring-white/10">
                        <div class="absolute -bottom-6 -right-6 w-full h-full bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl -z-10"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="space-y-6">
                    <div class="inline-block">
                        <span class="text-sm font-bold text-indigo-600 uppercase tracking-wider bg-indigo-50 px-4 py-2 rounded-full">About Us</span>
                    </div>
                    <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                        Where <span class="text-green-600">Jesus Reigns,</span> <span class="text-indigo-900">Rules</span><br>
                        and <span class="text-indigo-900">Resides</span>
                    </h2>
                    <p class="text-lg text-gray-600 leading-relaxed">
                        We are a family of God's people. We want to create a passionate commitment to Christ, His Cause, and His Community. Welcome to RCCG Open Heavens Parish.
                    </p>
                    <div class="pt-4">
                        <a href="contact-us.php" class="inline-flex items-center text-indigo-600 font-semibold hover:text-indigo-700 group">
                            Learn More About Us
                ...
                <div class="relative">
                    <div class="grid grid-cols-3 gap-4">
                        <img src="images/oh/03.jpg" alt="Church member" class="rounded-2xl shadow-lg w-full h-72 object-cover transform hover:scale-105 transition-transform duration-300">
                        <img src="images/oh/05.jpg" alt="Church members" class="rounded-2xl shadow-lg w-full h-72 object-cover transform hover:scale-105 transition-transform duration-300 mt-8">
                        <img src="images/oh/01.jpg" alt="Church member" class="rounded-2xl shadow-lg w-full h-72 object-cover transform hover:scale-105 transition-transform duration-300">
                    </div>
                    <!-- Decorative element -->
                    <div class="absolute -bottom-8 -left-8 w-64 h-64 bg-indigo-100 rounded-full blur-3xl opacity-50 -z-10"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 px-6 bg-gray-50">
        <div class="container mx-auto max-w-7xl">
            <div class="text-center mb-16">
                <span class="text-sm font-bold text-indigo-600 uppercase tracking-wider bg-indigo-50 px-4 py-2 rounded-full inline-block mb-4">Explore</span>
                <h2 class="text-4xl md:text-5xl font-bold text-gray-900">Discover Our Ministry</h2>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <!-- Events Card -->
                <a href="events.php" class="relative h-96 rounded-2xl overflow-hidden shadow-xl group cursor-pointer card-overlay transform transition-all duration-500">
                    <img src="images/oh/08.jpg" alt="Events" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                ...
                <!-- Giving Card -->
                <a href="giving.php" class="relative h-96 rounded-2xl overflow-hidden shadow-xl group cursor-pointer card-overlay transform transition-all duration-500">
                    <img src="images/oh/04.jpg" alt="Giving" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    <div class="absolute inset-0 z-10"></div>
                    <div class="absolute bottom-10 left-10 text-white z-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Sermon Card -->
                <a href="sermons.php" class="relative h-96 rounded-2xl overflow-hidden shadow-xl group cursor-pointer card-overlay transform transition-all duration-500">
                    <img src="images/oh/09.jpg" alt="Sermon" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    <div class="absolute inset-0 z-10"></div>
                    <div class="absolute bottom-10 left-10 text-white z-20">
                ...
                <!-- Discover Card -->
                <a href="contact-us.php" class="relative h-96 rounded-2xl overflow-hidden shadow-xl group cursor-pointer card-overlay transform transition-all duration-500">
                    <img src="images/oh/07.jpg" alt="Discover" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    <div class="absolute inset-0 z-10"></div>
                    <div class="absolute bottom-10 left-10 text-white z-20">
            ...
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="space-y-6">
                    ...
                    <h2 class="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                        Feel The<br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">Xpression!</span>
                    </h2>
                    <p class="text-xl text-gray-300 leading-relaxed">
                        We are launching a new kind of Youth ministry. Join the experience and operation in God's Presence.
                    </p>
                    <div class="pt-4">
                        <a href="contact-us.php" class="btn-hover inline-block border-2 border-white px-8 py-4 hover:bg-white hover:text-black font-semibold transition-all duration-300 uppercase tracking-wider rounded-lg">
                            PLAN TO VISIT
                        </a>
                    </div>
                </div>
                <div class="relative">
                    <img src="images/oh/08.jpg" alt="Youth Ministry" class="rounded-2xl shadow-2xl w-full h-[500px] object-cover ring-4 ring-purple-500/20">
    ...
    <section class="py-24 px-6 bg-gradient-to-b from-white to-green-50 relative overflow-hidden">
        ...
        <div class="container mx-auto max-w-7xl relative z-10">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="space-y-6">
                    <div class="inline-block">
                        <span class="text-sm font-bold text-green-600 uppercase tracking-wider bg-green-50 px-4 py-2 rounded-full">Prayer Request</span>
                    </div>
                    <h2 class="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                    ...
                    <p class="text-xl text-gray-600 leading-relaxed">
                        If you need someone to pray with you concerning specific needs, please write and send us your prayer request(s). We will be glad to pray with you and pray for you.
                    </p>
                    <div class="pt-4">
                        <a href="contact-us.php" class="btn-hover inline-block bg-indigo-900 text-white px-8 py-4 hover:bg-indigo-800 font-semibold transition-all duration-300 uppercase tracking-wider rounded-lg shadow-xl hover:shadow-2xl">
                            REQUEST PRAYER
                        </a>
                    </div>
                </div>
                <div class="relative">
                    <img src="images/oh/10.jpg" alt="Person Praying" class="rounded-2xl shadow-2xl w-full h-[500px] object-cover ring-4 ring-green-500/10">
                    <div class="absolute -bottom-8 -right-8 w-full h-full bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl -z-10 opacity-20"></div>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-sm card-hover">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="<?php echo $category_color; ?> text-white px-3 py-1 rounded-full text-sm font-semibold">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div class="bg-neutral-50 rounded-2xl overflow-hidden shadow-sm card-hover">
                    <div class="relative">
                        <img src="<?php echo htmlspecialchars($event['image'] ?? $default_images[$image_index++ % count($default_images)]); ?>"
