...
<head>
    ...
    <meta name="description" content="Listen to powerful sermons and messages from RCCG Open Heavens Parish. Be inspired by God's Word.">
    ...
    <section class="relative bg-gradient-to-br from-[#0d47a1] to-[#001845] text-white pt-32 pb-20">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex items-center justify-center text-white/80">
                ...
                <span class="text-yellow-400">Sermons</span>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-sm card-hover">
                    <div class="relative">
                        <img src="<?php echo htmlspecialchars($sermon['thumbnail'] ?? $default_images[$image_index++ % count($default_images)]); ?>" alt="Sermon" class="w-full h-56 object-cover">
                        <?php if ($sermon['category']): ?>
                        <div class="absolute top-4 left-4">
                            <span class="bg-primary text-white px-3 py-1 rounded-full text-sm font-semibold"><?php echo htmlspecialchars($sermon['category']); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-neutral-100">
                            ...
                            <a href="sermon-details.php?id=<?php echo $sermon['id']; ?>" class="text-[#0d47a1] font-semibold hover:text-[#0d47a1]/80 transition flex items-center">
            ...
            <div class="flex justify-center mt-12">
                <nav class="flex items-center space-x-2">
                    <button class="px-4 py-2 bg-neutral-200 text-neutral-700 rounded-lg hover:bg-neutral-300 transition">
                        <i class="fas fa-chevron-left"></i>
                    </button>
                    <button class="px-4 py-2 bg-primary text-white rounded-lg font-semibold">1</button>
                    <button class="px-4 py-2 bg-neutral-200 text-neutral-700 rounded-lg hover:bg-neutral-300 transition">2</button>
                    <button class="px-4 py-2 bg-neutral-200 text-neutral-700 rounded-lg hover:bg-neutral-300 transition">3</button>
                    <button class="px-4 py-2 bg-neutral-200 text-neutral-700 rounded-lg hover:bg-neutral-300 transition">
    ...
    <section class="py-16 bg-gradient-to-br from-[#0d47a1] to-[#001845] text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <input type="email" placeholder="Enter your email" class="px-6 py-3 rounded-lg text-neutral-900 focus:outline-none focus:ring-2 focus:ring-yellow-400">
