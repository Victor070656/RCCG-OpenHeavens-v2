            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-sm mb-0 mt-8">
                        <a href="members/index.php" class="text-main-600 hover-text-decoration-underline">View all members</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-sm mb-0 mt-8">
                        <a href="events/index.php" class="text-main-600 hover-text-decoration-underline">View all events</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-sm mb-0 mt-8">
                        <a href="sermons/index.php" class="text-main-600 hover-text-decoration-underline">View all sermons</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-sm mb-0 mt-8">
                        <a href="messages/index.php" class="text-main-600 hover-text-decoration-underline">View all messages</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100">
                <div class="card-header">
                    <div class="flex-between flex-wrap gap-8">
                        ...
                        <a href="events/index.php" class="text-main-600 text-sm hover-text-decoration-underline">View All</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <?php while ($event = $recent_events->fetch_assoc()): ?>
                                <div class="d-flex align-items-start gap-12 mb-16 pb-16 border-bottom border-gray-100">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-4">
                                            <a href="events/edit.php?id=<?php echo $event['id']; ?>" class="text-gray-900 hover-text-main-600">
                    ...
                    <?php else: ?>
                        <div class="text-center py-40">
                            ...
                            <a href="events/add.php" class="btn btn-main btn-sm mt-12">Add New Event</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card h-100">
                <div class="card-header">
                    <div class="flex-between flex-wrap gap-8">
                        ...
                        <a href="sermons/index.php" class="text-main-600 text-sm hover-text-decoration-underline">View All</a>
                    </div>
                </div>
                <div class="card-body">
                    <?php if ($recent_sermons && $recent_sermons->num_rows > 0): ?>
                        <div class="max-h-350 overflow-y-auto scroll-sm">
                            <?php while ($sermon = $recent_sermons->fetch_assoc()): ?>
                                <div class="d-flex align-items-start gap-12 mb-16 pb-16 border-bottom border-gray-100">
                                    <span class="flex-shrink-0 w-40 h-40 flex-center rounded-circle bg-purple-50 text-purple-600">
                                        <i class="ph ph-book-open text-xl"></i>
                                    </span>
                                    <div class="flex-grow-1">
                                        <h6 class="mb-4">
                                            <a href="sermons/edit.php?id=<?php echo $sermon['id']; ?>" class="text-gray-900 hover-text-main-600">
                    ...
                    <?php else: ?>
                        <div class="text-center py-40">
                            ...
                            <a href="sermons/add.php" class="btn btn-main btn-sm mt-12">Add New Sermon</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-3 col-sm-6">
                    <a href="events/add.php" class="btn btn-outline-main w-100 py-12">
                        <i class="ph ph-plus-circle me-8"></i>
                        Add New Event
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="sermons/add.php" class="btn btn-outline-main w-100 py-12">
                        <i class="ph ph-plus-circle me-8"></i>
                        Add New Sermon
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="members/add.php" class="btn btn-outline-main w-100 py-12">
                        <i class="ph ph-plus-circle me-8"></i>
                        Add New Member
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="messages/index.php" class="btn btn-outline-main w-100 py-12">
