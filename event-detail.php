...
<body class="bg-neutral-50">
    ...
    <section class="relative bg-gradient-to-br from-[#0d47a1] to-[#001845] text-white pt-32 pb-20">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-center"><?php echo htmlspecialchars($event['title']); ?></h1>
            ...
            <div class="flex justify-center mb-4">
                ...
                ?>
                <span class="<?php echo $status_color; ?> text-white px-4 py-2 rounded-full text-sm font-bold uppercase">
            ...
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mb-8 rounded-2xl overflow-hidden shadow-lg">
                        <img src="<?php echo htmlspecialchars($event['image']); ?>" alt="<?php echo htmlspecialchars($event['title']); ?>" class="w-full h-96 object-cover">
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="prose prose-lg max-w-none">
                            <p class="text-neutral-700 leading-relaxed whitespace-pre-line"><?php echo htmlspecialchars($event['description']); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-neutral-200 rounded-2xl p-6">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode($event['title']); ?>&url=<?php echo urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>" target="_blank" class="bg-sky-500 hover:bg-sky-600 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center">
                                <i class="fab fa-twitter mr-2"></i>
                                Twitter
                            </a>
                            <a href="https://api.whatsapp.com/send?text=<?php echo urlencode($event['title'] . ' - ' . 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>" target="_blank" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center">
                ...
                <div class="lg:col-span-1">
                    <!-- Event Info Card -->
                    <div class="bg-gradient-to-br from-[#0d47a1] to-[#001845] text-white rounded-2xl p-8 mb-6 sticky top-24">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="font-bold"><?php echo date('F j, Y', strtotime($event['start_date'])); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="bg-neutral-50 rounded-2xl p-6">
                        ...
                        <p class="text-neutral-600 mb-4">Have questions about this event? We'd love to hear from you!</p>
                        <a href="contact-us.php" class="block w-full bg-primary hover:bg-primary/90 text-white text-center py-3 rounded-lg font-semibold transition">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-sm card-hover">
                    <div class="relative">
                        <img src="<?php echo htmlspecialchars($related['image'] ?? $default_images[$img_index++ % count($default_images)]); ?>" alt="Event" class="w-full h-48 object-cover">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-bold text-neutral-900 mb-2 hover:text-[#0d47a1] transition">
                            <a href="event-detail.php?id=<?php echo $related['id']; ?>"><?php echo htmlspecialchars($related['title']); ?></a>
                        </h3>
                        ...
                        <a href="event-detail.php?id=<?php echo $related['id']; ?>" class="block w-full text-center bg-primary hover:bg-primary/90 text-white py-2 rounded-lg font-semibold transition">
                            View Details
                        </a>
                    </div>
                </div>
